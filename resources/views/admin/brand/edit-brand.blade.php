        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-10 m-auto">
                    <div class="card">
                        <div class="panel-heading">
                            <h4 class="text-center text-success" >Update Brand</h4>
                        </div>
                        <div class="card-body">
                            <h3 class="text-center text-success ">{{Session::get('message')}}</h3>
                            <h3 class="text-center text-success">{{Session::get('update message')}}</h3>
                            <form action="{{route('update-brand')}}" method="POST" class="form-control">
                                {{csrf_field()}}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="brand_description"  class="form-control" cols="10" rows="5">{{$brand->brand_description}}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 radio">
                                        ...
                                        <label> <input type="radio" checked name="published" {{$brand->published==1 ? 'checked':''}} value="1"/> Published</label>
                                        <label> <input type="radio" name="published" {{$brand->published==0 ?'checked':''}} value="0"/> Unpublished<br></label>
